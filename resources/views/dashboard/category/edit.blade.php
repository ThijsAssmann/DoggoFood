           ...
           <div class="container">
               <div class="jumbotron">
                   {{-- HTML::ul($errors->all()) --}}
                    ...
                    @endif
               <div class="row">
                    <form method="post" action="{{ URL::to('dashboard/category/update/' . $category->id) }}">
                    {{ csrf_field() }}
                           ...
                           <div class="row">
                               <div class="col-md-12">
                                   <div class="form-group label-floating">
                                       ...
                                       <input type="text" class="form-control hidden" id="id" name="id" required="" value="{{$category->id}}" readonly="">
                                   </div>
                               </div>
                           </div>
                           <div class="row">
                               <div class="col-md-12">
                                   <div class="form-group label-floating">
                                       ...
                                       <textarea id="desc" class="form-control" name="desc" required="">{{$category->desc}}</textarea>
                                   </div>
                               </div>
                           </div>
                           <div class="row">

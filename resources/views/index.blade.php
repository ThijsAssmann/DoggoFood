...
<div class="container marketing">
  ...
  <div class="row featurette">
    <div class="col-md-7">
      <h2 class="featurette-heading">Welkom bij DoggoFood, <span class="text-muted">de beste hondenvoer webshop van Nederland.</span></h2>
      <p class="lead">DoggoFood heeft een groot assortiment aan gezonde natuurlijk, gedroogde hondensnacks voor alle hondenrassen. Deze snacks zijn een goede keuze en geef je als beloning, trainer, bijvoeding en gebitsverzorging. Gedroogde snacks zijn heel lang houdbaar mits ze droog en goed afgesloten bewaard worden. We hanteren zeer scherpe prijzen voor groot– en kleinverbruiker.</p><br>
    </div>
  </div>

...
@section('content')
    <div class="main container">
        ...
        <div class="row">
            <div class="col-lg-2">
                <img class="img-rounded" src="@if (strpos($product->picture, 'http') !== false) {{ $product->picture }} @else {{ asset('../storage/app/'.$product->picture) }} @endif" alt="Generic placeholder image" width="150" height="150">
            </div>
